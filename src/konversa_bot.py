...
async def echo_handler(message: Message) -> None:
    ...
    match user_intention:
        ...
        case "reserve_meeting":
            ...
            if not cm.get_user_data("session"):
                ...
                if order == 'begin':
                    ...
                    if not current_req in the_data:
                        current_order = int(order) + 1
                        current_order_str = str(current_order)
                        the_data[current_req] = message.text
        ...
        case _:
            ...
            elif cm.get_user_data("session") == 'begin':
                the_reply = "Let's get started"
            else:
                the_reply = "Your answer: " + message.text + " has been saved"
